    ...
    public class Продукты : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПродуктыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПродуктыE", typeof(IIS.Restoran1.Продукты));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПродуктыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПродуктыL", typeof(IIS.Restoran1.Продукты));
                }
            }
        }
    }
